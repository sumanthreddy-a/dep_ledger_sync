...
initConfigValue('RETRY_WAIT', 10000)
initConfigValue('VALIDATOR_URL', 'tcp://159.65.157.166:4040')
// initConfigValue('DB_HOST', 'localhost')
initConfigValue('DB_HOST', '139.59.1.94')
initConfigValue('DB_PORT', 28015)
initConfigValue('DB_NAME', 'poc')
// initConfigValue('USER', 'admin')
// initConfigValue('PASSWORD', '')
initConfigValue('authKey','',)
initConfigValue('url','http://159.65.157.166:8020/blocks/',)
